...
class Evaluator(object):
    ...
    def __init__(self, output_pcl_dir, dataset_root, dataset, subset, summary_dir, experiment_name, device='cuda', res_gts='gt_4096', logger=BlackHole()):
        super().__init__()
        ...
        self.gts_pcl_dir = os.path.join(dataset_root, dataset, 'test', subset, res_gts)
        self.gts_mesh_dir = os.path.join(dataset_root, dataset, 'test', 'original_meshes')
